...
well yet produce unreliable operational decisions when its validation-derived
threshold does not transfer to a shifted deployment distribution.
...
are malicious. Under one common validation-FPR policy, TabRF obtains an F1 score of 0.7210,
RF-500 obtains 0.7043, and MetaRF obtains 0.6756; the hybrid fusion
