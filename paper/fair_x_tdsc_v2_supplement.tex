...
\title{Supplementary Material for ``FAIR-X: A Threshold-Transfer Evaluation Contract for Behavioral Malware Detection under Distribution Shift''}
...
Table~\ref{tab:supp_hyperparameters} lists the principal fitted-model
configuration.
